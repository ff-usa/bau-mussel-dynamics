...
ggscatter(df, x = "Depth", y = "mean",
          ...
          xlab = "Depth (m)", ylab = "Population / m^2",
          title = 'A') +
  stat_cor(cor.coef.name = 'rho', label.x=1.5, label.y=2.8, method='spearman', size=5)
```
...
ggscatter(df, x = "Temperature", y = "mean",
          ...
          xlab = "Temperature (°C)", ylab = "Population / m^2",
          title = 'B') +
  stat_cor(cor.coef.name = 'rho', label.x=20, label.y=3.4, method='spearman', size=5)
```
```{r}
library("ggpubr")
ggscatter(df, x = "pH", y = "mean",
          ...
          xlab = "pH", ylab = "Population / m^2",
          title = 'C') +
  stat_cor(cor.coef.name = 'rho', label.x=6.9, label.y=3.4, method='spearman', size=5)
```

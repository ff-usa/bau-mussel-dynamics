...
# tiff("docs/Fig_3.tiff", height=4, width=6, units='in', res=300)
par(mar=c(6, 4.5, 1, 1))
magnify=1.2
plot(mean,
     type='b', col='blue',
     xlab='', ylab=expression(Population~density~(no./m^2)), xlim=c(1,12), xaxt='n', lwd=2,
     cex.axis = magnify, cex.lab = magnify)

# legend('top', legend=c('Mean'), col=c('blue'), lwd=c(3), lty=1)

axis(1, at=seq(1,12), population$Month, las=2, cex.axis = magnify)
...
library("ggpubr")
library(cowplot)
# tiff("docs/Fig_4.tiff", height=9, width=5, units='in', res=300)
